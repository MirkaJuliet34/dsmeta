...
function SalesCard() {
    ...
    useEffect(() => { //Buscou informações dentro do meu backend e guardou dentro de sales
        ...
        <div className="dsmeta-card">
            ...
            <div>
                <div className="dsmeta-form-control-container">
                    <DatePicker
                        selected={minDate}
                        onChange={(date: Date) => setMinDate(date)} //Alterar a data mínima  dentro do componente
                ...
                <div className="dsmeta-form-control-container">
                    <DatePicker
                        selected={maxDate}
                        onChange={(date: Date) => setMaxDate(date)} //Alterar a data máxima dentro do componente
                        className="dsmeta-form-control"
                        dateFormat="dd/MM/yyyy"
                    />
                </div>
            ...
            <div>
                <table className="dsmeta-sales-table">
                    ...
                    <tbody>
                        {sales.map(sale => { //Pecorre a lista e faz conexão com cada elemento.
                            return (
                                <tr key={sale.id}>
